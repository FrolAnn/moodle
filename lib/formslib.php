...
abstract class moodleform {
     ...
     * @param string $repeathiddenname name for hidden element storing no of repeats in this form
     * @param string $addfieldsname name for button to add more fields
     * @param string $repeatname name of field with number of elements
     * @param string $text text before the field with number of elements
     * @param bool $addbuttoninside if true, don't call closeHeaderBefore($addfieldsname). Default false.
     * @return int no of repeats of element in this page
     */
    function repeat_elements2($elementobjs, $repeats, $options, $repeathiddenname,
            $addfieldsname, $repeatname, $text, $addbuttoninside=false){
